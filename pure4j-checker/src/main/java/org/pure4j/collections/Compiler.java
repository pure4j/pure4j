...
import org.pure4j.collections.bin.ILookupSite;
import org.pure4j.collections.bin.ILookupThunk;
import org.pure4j.collections.bin.Intrinsics;
import org.pure4j.collections.bin.Keyword;
import org.pure4j.collections.bin.KeywordLookupSite;
import org.pure4j.collections.bin.LispReader;
import org.pure4j.collections.bin.Namespace;
import org.pure4j.collections.bin.Symbol;
import org.pure4j.collections.bin.WarnBoxedMath;
...
//		gen.getStatic(fntype, munge(k.sym.toString()), KEYWORD_TYPE);
	...
	Type constantType(int id){
		...
		Class c = org.pure4j.collections.Util.classOf(o);
